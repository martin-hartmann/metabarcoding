...
cutadapt -g ^AACTTTYRRCAAYGGATCWCT -G ^AGCCTCCGCTTATTGATATGCTTAART -e 0.12 -m 1 --trimmed-only -o 3.all.trim.R1.fastq -p 3.all.trim.R2.fastq 2.all.nophix.R1.fastq 2.all.nophix.R2.fastq # trim primers
